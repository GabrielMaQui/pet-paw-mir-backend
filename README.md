# <div align="center"><img src="src/img/readme/images/gifs/paws1.gif" alt="Paws Gif" width="100" /> Pet Paws <img src="src/img/readme/images/gifs/paws1.gif" alt="Paws Gif" width="100" /> </div>

<img src="src/img/readme/images/banner/bannerl.png" alt="Pet Paws Banner">
...
<a href="https:/www.facebook.com/PetPawsApp" style="margin-right: 15">
  <img src="src/img/readme//images/icon-svg/facebook.svg" alt="Facebook Icon" width="60" />
</a>
&nbsp;
<a href="https://www.instagram.com/petpawsapp" style="margin-right: 15">
  <img src="src/img/readme//images/icon-svg/instagram.svg" alt="Instagram Icon" width="60" />
</a>
&nbsp;
<a href="#">
  <img src="src/img/readme//images/icon-svg/discord.svg" alt="Discord Icon" width="60"/>
</a>
</div>
...
### Frontend
<div>
<img src="src/img/readme/images/icons/typescript.png" alt="Typescript Icon" width="60" style="margin: 0 7.5px"/>
  &nbsp;
<img src="src/img/readme/images/icons/tailwind.png" alt="Tailwind Icon" width="60" style="margin: 0 7.5px"/>
  &nbsp;
<img src="src/img/readme/images/icons/mapbox.png" alt="MapBox Icon" width="60" style="margin: 0 7.5px"/>
  &nbsp;
<img src="src/img/readme/images/icons/reactjs.png" alt="Reactjs Icon" width="60" style="margin: 0 7.5px"/>
  &nbsp;
<img src="src/img/readme/images/icons/vue.png" alt="Vue Icon" width="60" style="margin: 0 7.5px"/>
</div>

### Backend

<div>
<img src="src/img/readme/images/icons/nodejs.png" alt="Node Icon" width="60" style="margin: 0 7.5px"/>
  &nbsp;
<img src="src/img/readme/images/icons/socketio.png" alt="Socket.IO Icon" width="60" style="margin: 0 7.5px"/>
</div>

### Base de Datos

<img src="src/img/readme/images/icons/postgresql.png" alt="PostgreSQL Icon" width="60" style="margin: 0 7.5px"/>

### Cloud & Hosting

<div>
<img src="src/img/readme/images/icons/vercel.svg" alt="Vercel Icon" width="60" style="margin: 0 7.5px"/>
  &nbsp;
<img src="src/img/readme/images/icons/netlify.svg" alt="Netlify Icon" width="60" style="margin: 0 7.5px"/>
  &nbsp;
<img src="src/img/readme/images/icons/heroku.png" alt="Heroku Icon" width="40" style="margin: 0 7.5px"/>
</div>

### Media & Archivos

<img src="src/img/readme/images/icons/cloudinary.png" alt="Cloudinary Icon" width="60" style="margin: 0 7.5px"/>

### Testing

<img src="src/img/readme/images/icons/cypress.png" alt="Cloudinary Icon" width="60" style="margin: 0 7.5px"/>
...
|-------------------------|---------------------------------------------------------------------------------------------|
| **Backend**             | Express, compose-middleware, CORS, Morgan                                                  |
| **Autenticación y Seguridad** | Bcrypt, JSON Web Token (jsonwebtoken)                                                        |
| **WebSockets**          | Socket.io                                                                                  |
| **Generación de Documentación** | Swagger-jsdoc, Swagger-ui-express                                                           |
| **Base de Datos**       | Prisma, @prisma/client                                                                     |
| **Gestión de Fechas**   | Date-fns                                                                                   |
| **Manipulación de Datos** | JSON-BigInt                                                                                |
| **Correo Electrónico**  | Nodemailer, MailerSend                                                                     |
| **Lenguaje de Programación** | TypeScript                                                                               |
| **Herramientas de Desarrollo** | TSX, Husky, Lint-staged, @biomejs/biome                                                 |
| **Tipado**              | Paquetes @types (Node, Express, Bcrypt, Cors, etc.)                                        |
...
<div>
<img src="src/img/readme/images/colors/FFFFFF.png" alt="FFFFFF Color" width="60" style="margin: 0 7.5px"/>
  &nbsp;
<img src="src/img/readme/images/colors/FFE4E2.png" alt="FFE4E2 Color" width="60" style="margin: 0 7.5px"/>
  &nbsp;
<img src="src/img/readme/images/colors/FFB0A9.png" alt="FFB0A9 Color" width="60" style="margin: 0 7.5px"/>
  &nbsp;
<img src="src/img/readme/images/colors/FF797D.png" alt="FF797D Color" width="60" style="margin: 0 7.5px"/>
  &nbsp;
<img src="src/img/readme/images/colors/FF585D.png" alt="FF585D Color" width="60" style="margin: 0 7.5px"/>
  &nbsp;
<img src="src/img/readme/images/colors/FF353A.png" alt="FF353A Color" width="60" style="margin: 0 7.5px"/>
  &nbsp;
<img src="src/img/readme/images/colors/FF252F.png" alt="FF252F Color" width="60" style="margin: 0 7.5px"/>
  &nbsp;
<img src="src/img/readme/images/colors/D9534F.png" alt="D9534F Color" width="60" style="margin: 0 7.5px"/>
  &nbsp;
<img src="src/img/readme/images/colors/C9302C.png" alt="C9302C Color" width="60" style="margin: 0 7.5px"/>
</div>
...
<div>
<img src="src/img/readme/screenshots/wireframe-mobile.png" alt="ScreenShot WireFrame Mobile" height="300" style="margin: 0 7.5px"/>
  &nbsp;
<img src="src/img/readme/screenshots/wireframe-desktop.png" alt="ScreenShot WireFrame Desktop" height="300" style="margin: 0 7.5px"/>
</div>
...
<div>
<img src="src/img/readme/screenshots/mockup-mobile.png" alt="MockUp Mobile" height="300" style="margin: 0 7.5px"/>
  &nbsp;
<img src="src/img/readme/screenshots/mockup-desktop.png" alt="MockUp Desktop" height="300" style="margin: 0 7.5px"/>
</div>
...
<a href="https://www.figma.com/design/QdrT1X1tpDvgPlli9pRl2J/Pet-Paws?node-id=0-1&node-type=canvas&t=wXHANSG2u6jNZMI5-0">
  <img src="src/img/readme/images/icons/design/figma.png" alt="Figma Icon" width="60" style="margin: 0 30px"/>
</a>
...
<div>
<img src="src/img/readme/images/icons/design/paint.png" alt="Paint Icon" width="60" style="margin: 0 7.5px"/>
  &nbsp;
<img src="src/img/readme/images/icons/design/figma.png" alt="Figma Icon" width="60" style="margin: 0 7.5px"/>
  &nbsp;
<img src="src/img/readme/images/icons/design/adobeillustrator.png" alt="Adobe IllustratorIcon" width="60" style="margin: 0 7.5px"/>
  &nbsp;
<img src="src/img/readme/images/icons/design/adobeanimate.png" alt="Adobe Animate Icon" width="60" style="margin: 0 7.5px"/>
  &nbsp;
<img src="src/img/readme/images/icons/design/svgator.png" alt="SVGator Icon" width="60" style="margin: 0 7.5px, border-radius: 50px"/>
  &nbsp;
<img src="src/img/readme/images/icons/design/lottiefiles.png" alt="LottieFiles Icon" width="60" style="margin: 0 7.5px"/>
  &nbsp;
<img src="src/img/readme/images/icons/design/createjs.png" alt="CreateJS Icon" width="55" style="margin: 0 7.5px"/>
</div>
<br>
...
<a href="https://legard2911.atlassian.net/jira/software/projects/MIRPG/boards/1">
  <img src="src/img/readme/images/icons/others/jira.png" alt="Jira Icon" width="60"/></a>
...
<a href="https://drive.google.com/drive/folders/1uL-igDqA1zyCBIwnc70UI95ipyvCxQeI?usp=drive_link">
  <img src="src/img/readme/images/icons/others/drive.png" alt="Drive Icon" width="60" style="margin: 10px"/>
</a>
...
<a href="https://discord.gg/nmFkjq57">
  <img src="src/img/readme/images/icon-svg/discord.svg" alt="Discord Icon" width="60" style="margin: 10px"/>
</a>
